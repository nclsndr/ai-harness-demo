...
description: Creates git commits following Conventional Commits. Use when the user asks to commit, write a commit message, stage and commit, or organize semantic commits before pushing.
---

# Conventional Commit (Codex)
