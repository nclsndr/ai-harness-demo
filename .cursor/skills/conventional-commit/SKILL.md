...
description: Creates git commits following Conventional Commits. Use when the user asks to commit, write a commit message, stage and commit, or clean up commits before a push.
disable-model-invocation: true
---

# Conventional Commit (Cursor)
